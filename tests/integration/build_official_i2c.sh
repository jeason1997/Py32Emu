...
project=$sdk/Projects/PY32F002A-STK/Example/I2C/I2C_TwoBoard_CommunicationMaster_Polling
build=$root/build/official-i2c
mkdir -p "$build/obj"
...
$sdk/Drivers/PY32F0xx_HAL_Driver/Src/py32f0xx_hal_i2c.c
"
...
arm-none-eabi-gcc -mcpu=cortex-m0plus -mthumb -nostdlib \
    ...
    "$build/obj/startup.o" $objects -lgcc -o "$build/i2c_master.elf"
arm-none-eabi-objcopy -O binary "$build/i2c_master.elf" "$build/i2c_master.bin"
arm-none-eabi-size "$build/i2c_master.elf"
