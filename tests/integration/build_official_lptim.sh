...
project=$sdk/Projects/PY32F002A-STK/Example/LPTIM/LPTIM_WakeUp
build=$root/build/official-lptim
mkdir -p "$build/obj"
...
$sdk/Drivers/PY32F0xx_HAL_Driver/Src/py32f0xx_hal_rcc_ex.c
...
$sdk/Drivers/PY32F0xx_HAL_Driver/Src/py32f0xx_hal_lptim.c
"
objects=""
...
arm-none-eabi-gcc -mcpu=cortex-m0plus -mthumb -nostdlib \
    ...
    "$build/obj/startup.o" $objects -lgcc -o "$build/lptim.elf"
arm-none-eabi-size "$build/lptim.elf"
