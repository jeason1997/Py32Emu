...
project=$sdk/Projects/PY32F002A-STK/Example/CRC/CRC_Computing_Results
build=$root/build/official-crc
mkdir -p "$build/obj"
...
$sdk/Drivers/PY32F0xx_HAL_Driver/Src/py32f0xx_hal_crc.c
"
objects=""
...
arm-none-eabi-gcc -mcpu=cortex-m0plus -mthumb -nostdlib \
    ...
    "$build/obj/startup.o" $objects -lgcc -o "$build/crc.elf"
arm-none-eabi-size "$build/crc.elf"
