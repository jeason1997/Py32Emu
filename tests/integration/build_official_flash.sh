...
project=$sdk/Projects/PY32F002A-STK/Example/FLASH/FLASH_PageEraseAndWrite
build=$root/build/official-flash
mkdir -p "$build/obj"
...
$sdk/Drivers/PY32F0xx_HAL_Driver/Src/py32f0xx_hal_flash.c
"
objects=""
...
arm-none-eabi-gcc -mcpu=cortex-m0plus -mthumb -nostdlib \
    ...
    "$build/obj/startup.o" $objects -lgcc -o "$build/flash.elf"
arm-none-eabi-size "$build/flash.elf"
