...
project=$sdk/Projects/PY32F002A-STK/Example/IWDG/IWDG_RESET
build=$root/build/official-iwdg
mkdir -p "$build/obj"
...
$sdk/Drivers/PY32F0xx_HAL_Driver/Src/py32f0xx_hal_iwdg.c
"
objects=""
...
arm-none-eabi-gcc -mcpu=cortex-m0plus -mthumb -nostdlib \
    ...
    "$build/obj/startup.o" $objects -lgcc -o "$build/iwdg.elf"
arm-none-eabi-size "$build/iwdg.elf"
